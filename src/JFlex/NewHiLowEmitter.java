 ...
 */
public class NewHiLowEmitter extends NewPackEmitter {
   ...
   */
  public NewHiLowEmitter(String name) {
    super(name);
  }
  ...
  public void emitUnpack() {
    ...
    println("\";");
    nl();
    println("  private int [] zzUnpack"+name+"() {");
    ...
    nl();
    println("  private int zzUnpack"+name+"(String packed, int offset, int [] result) {");
    println("    int i = 0;  /* index in packed string  */");
    println("    int j = offset;  /* index in unpacked array */");
    println("    int l = packed.length();");
    println("    while (i < l) {");
    println("      int highVal = packed.charAt(i++);");
    println("      int lowVal = packed.charAt(i++);");
    println("      int high = highVal << 16;");
    println("      result[j++] = high | lowVal;");
    println("    }");
    println("    return j;");
    println("  }");
  }
